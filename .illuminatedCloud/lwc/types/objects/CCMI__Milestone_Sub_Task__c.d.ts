...
/**
 * <h3><b>Project Sub Task</b></h3>
 * <p>Used for capturing the sub tasks that form part of the tasks in the Cloud Coach Fundamentals app (Formerly Cloud Coach Milestones)</p>
 */
declare interface CCMI__Milestone_Sub_Task__c extends SObject 
{
    ...
    Histories?: Milestone_Sub_Task__History[];
    IsDeleted?: boolean;
    LastModifiedBy?: User;
